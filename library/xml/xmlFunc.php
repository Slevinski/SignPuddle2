...
//* Function will attempt to open the xmlloc as a local file, on fail it will attempt to open it as a web link, else it will accept it as text */
function GetXMLTree($xmlloc) 
{ 
//hacking it
//  if (file_exists($xmlloc))
//    $data = implode('', file($xmlloc)); 
//  elseif (substr($xmlloc,0,4)=="http") {
//    $fp = fopen($xmlloc,'r');
